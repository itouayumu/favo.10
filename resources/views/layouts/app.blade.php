...
<body>
    ...
    <footer>
        <ul>
            ...
            <li class="timeline"><p>タイムライン</p><a href=""><img src="{{asset('img/timeline.png')}}" alt="タイムライン"></a></li>
            <li class="schedule"><p>予定表</p><a href=""><img src="{{asset('img/schedule.png')}}" alt="予定表"></a></li>
            <li class="search"><p>検索</p><a href=""><img src="{{asset('img/search.png')}}" alt="検索"></a></li>
